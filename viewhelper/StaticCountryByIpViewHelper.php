...
class StaticCountryByIpViewHelper  extends \TYPO3Fluid\Fluid\Core\ViewHelper\AbstractViewHelper {


	/**
	 * return the localization of the User as lowercase ISO2-code
	 *
	 * @param \TYPO3\KcHumbaurProducts\Domain\Model\Part $part
	 * @param \TYPO3\KcHumbaurProducts\Domain\Model\Trailer $trailer
	 * @return float
	 */
