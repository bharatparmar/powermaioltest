...
class HasAssembledPartSingleViewHelper extends \TYPO3Fluid\Fluid\Core\ViewHelper\AbstractViewHelper {
	...
	public function render() {
		...
		if(!$part instanceof \TYPO3\KcHumbaurProducts\Domain\Model\Part) return FALSE;
