...
class PriceByIsoViewHelper extends AbstractViewHelper
{
    /**
    ...
    {
        $this->registerArgument('iso', 'string', 'iso2 code', TRUE);
    }
    ...
    {
        return GeoIpHelper::Instance()->priceByIp($this->arguments['iso']);
    }
}
