...
class HasAssembledPartSingleFastViewHelper extends \TYPO3Fluid\Fluid\Core\ViewHelper\AbstractViewHelper {
	...
	public function render() {
		...
		$partAssembledArray[] = $partAssembled->findIfAssembled($partUid, $trailerUid);
